...
### 7. 運用サイクルまとめ
1. **BA:** 機能単位のシナリオ（.md）を作成  
2. **Dev:** MarkdownからPlaywrightコード自動
3. **QA:** テスト実行 → 結果・スクリーンショット取得  
4. **BA/Dev:** 必要に応じて修正依頼・再テスト  
5. **最終成果物:** 結果反映済みのHTMLシナリオ＋証跡  
